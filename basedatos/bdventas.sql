...
INSERT INTO empleados (idempleado, nombre, apellidos, dni, telefono, direccion) 
VALUES ('E001', 'Carlos', 'Vera Ruiz', '12345678', '912345678', 'Calle Ficticia 123');

INSERT INTO usuarios (idempleado, usuario, pass, acceso, estado) 
VALUES ('E001', 'cvera', '1234', 'NivelDeAcceso', 'AC');
 select * from usuario
